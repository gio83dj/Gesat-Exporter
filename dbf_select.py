...
marca1 = input ('Inserisci marchio 1 IN MAIUSCOLO: ')
marca2 = input ('Inserisci marchio 2 IN MAIUSCOLO: ')
...
while i < lungtot:
    ...
    if str(od['ANNO']) == "2019":
        if str(od['UT_STATO']) != "CON":
            if str(od['FL_REV']) != "R":
                if str(od['MARCA']) == marca1:
                    if str(od['SOCIETA']) == marca2:
                        ...
                        if str(od['UT_STATO']) == 'CON':
                            ...
                            print ('Consegnato: NO')
                        elif str(od['UT_STATO']) == 'RIE':
                            print ('--------SPEDITO--------')
                        print ('----------------------------------------------------------------------------------------------------------------------------------')
                        contatore += 1
    i = i + 1
print ("Ci sono "+str(contatore)+" ingressi "+marca1+" DA COMPLETARE!")
...
while indice < lungtot:
    ...
    if str(od['ANNO']) == "2019":
        if str(od['UT_STATO']) != "CON":
            ...
            if str(od['FL_REV']) == "R":
                file = open('ancora_da_ritirare.txt','a')
                file.write(str(od['SCHEDA']) + '\n')
                file.close()
